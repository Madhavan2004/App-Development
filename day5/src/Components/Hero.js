      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Welcome to Maddy's[Furniture Store]
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Discover Timeless Elegance and Comfort for Your Home

            Revamp your living space with [Furniture Heaven], where style meets affordability. 
            Explore our wide range of handcrafted furniture pieces designed to transform your house into a home.
            </p>
