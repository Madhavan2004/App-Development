    ...
    <Box m={"auto"}>
      ...
      <Box w={{base:"95%" ,md:"75%", lg:"50%"}} ml={{base: '0',sm: '2%' , md:'10%' }} mt={15} display={{ base: "none", sm: "flex" }} justifyContent="space-around" alignItems={"center"} >
        {/* <HStack gap={{ base: 2 , sm: 5, lg:10 }} fontWeight="bold" > */}
          ...
          <Text fontSize={"20px"} fontWeight={"bold"} >New At Shop's</Text>
      ...
      <Box w={{ base: "90%", lg: "82%" }} margin="auto">
        <Stack gap={2} mt={10} textAlign="left" mb={10}>
          ...
          <Text>
            Join Maddy's Family to get inspired, claim discounts, and receive
            rewards.
          </Text>
        </Stack>
      ...
      <Box w={{ base: "95%", lg: "90%" }} margin="auto" textAlign={"left"}>
        ...
        <Text py={4}>
          Share your photos on Instagram with #MADDYlifeathome or tag @maddy's.india
