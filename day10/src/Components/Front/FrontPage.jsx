  ...
  return (
    <div className={style.mainContainer}>
      <div className={style.frontNavbar}>
        <div className={style.frontNavbarHeading}>Furniture Store</div>
      ...
      <div className={style.Compoent_1watch_image}>
            ...
            style={{ borderRadius: "12px", width: "100%", height: "545px" }}
              src="https://c4.wallpaperflare.com/wallpaper/694/865/147/space-art-fantasy-art-sky-clouds-wallpaper-thumb.jpg"
              alt="watch"
            />
          </div>
     ...
     {/*}   <div className={style.Compoent_1Video}>
          <video
            ...
            controls
            alt="video"
            src="https://www.ikea.com/global/en/imges/nytillverkadstart_36b1f93d51.mp4"
            ref={videoEl}
          />
        </div>*/}
